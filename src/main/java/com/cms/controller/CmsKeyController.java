...
public class CmsKeyController {
    ...
    public CmsKeyResponse getKey(@NonNull @PathVariable UUID keyId) {
    ...
    public CmsKeyResponse toggleKeyStatus(@NonNull @PathVariable UUID keyId) {
        return cmsKeyService.toggleKeyStatus(keyId);
    }

    @DeleteMapping("/keys/{keyId}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteKey(@NonNull @PathVariable UUID keyId) {
